...
// CRM Tags table - for categorizing CRM projects
...
// CRM Project Tags - junction table for many-to-many relationship
...
export type InsertCrmProjectTag = Omit<CrmProjectTag, "id" | "createdAt">;
